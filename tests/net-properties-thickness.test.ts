...
test("Different trace thicknesses should result in different cache keys", () => {
  const { cacheKey: cacheKey1, normalizedAutoroutingJson: normalizedAutoroutingJson1 } =
    generateCacheKey(circuitJsonWithTraceThickness1 as any)
  const { cacheKey: cacheKey2, normalizedAutoroutingJson: normalizedAutoroutingJson2 } =
    generateCacheKey(circuitJsonWithTraceThickness2 as any)

  expect(cacheKey1).toMatchInlineSnapshot(`"8bd5f1de68468eadd235a5b93fb5132b"`)
  ...
  expect(cacheKey2).toMatchInlineSnapshot(`"92b71dd76d9a1b58198f3e14d707ea35"`)
